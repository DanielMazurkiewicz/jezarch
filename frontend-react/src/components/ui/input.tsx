  ...
  return (
    <input
      ...
      className={cn(
        ...
        // Ensure input has a background, using input variable which maps to border color by default,
        // but provides a solid base. Override if needed per-instance.
        "dark:bg-input/30 bg-background", // Changed bg-transparent to bg-background
