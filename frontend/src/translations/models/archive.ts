...
export type ArchiveTranslationKey =
  ...
  | 'archiveFormPlaceLabel'
  | 'archiveFormPlacePlaceholder'
  | 'archiveFormSealsLabel'
  | 'archiveFormSealsPlaceholder'
  | 'archivePreviewPlaceLabel'
  | 'archivePreviewSealsLabel'
  ...
  | 'archiveFormImportFromParentTooltip' // e.g., 'Import value of "{field}" from parent unit'
  | 'archiveFormImportReplaceTitle' // e.g., 'Replace value of "{field}"?'
  | 'archiveFormImportReplaceDescription' // e.g., 'This field already has a value. Do you want to replace it with the value from the parent unit?'
  | 'archiveFormImportReplaceAction' // e.g., 'Replace'
