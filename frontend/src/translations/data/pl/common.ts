...
export const commonTranslationsPL: CommonTranslationSet = {
  ...
  allLabel: 'Wszystkie',
  noneLabel: 'Brak',
  noTagsAssignedLabel: 'Brak przypisanych tagów',
  itemLabel: 'Element',
  itemsLabel: 'Elementy',
  ...
  showFiltersButton: 'Pokaż filtry',
  hideFiltersButton: 'Ukryj filtry',
  ...
  errorBoundaryUnexpectedError: 'Wystąpił nieoczekiwany błąd.',
  errorBoundaryReturnHomeButton: 'Wróć na stronę główną',
  authenticationMissingError: 'Błąd uwierzytelnienia.',
  changePasswordFailedError: 'Nie udało się zmienić hasła.',
  headerUserMenuLabel: 'Menu użytkownika',
  moreItemsBadge: '+{count} więcej',
  defaultUserName: 'Użytkownik',
  roleAdminLabel: 'administrator',
  roleEmployeeLabel: 'pracownik',
  roleUserLabel: 'użytkownik',
  paginationNavAriaLabel: 'paginacja',
  paginationPreviousAriaLabel: 'Przejdź do poprzedniej strony',
  paginationNextAriaLabel: 'Przejdź do następnej strony',
  paginationMorePagesLabel: 'Więcej stron',
