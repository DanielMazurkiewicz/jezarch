...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        "z-50 min-w-[8rem] origin-[var(--radix-dropdown-menu-content-transform-origin)] overflow-hidden rounded-md border p-1 shadow-md",
        // Force white background and dark text for sub-content as well
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      className={cn(
        // Ensure label text contrasts with white background
        "text-neutral-600 px-2 py-1.5 text-xs",
        inset && "pl-8",
        className
      )}
      {...props}
